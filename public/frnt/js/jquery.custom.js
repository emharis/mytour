...
//         $( '#nav > ul, #nav .menu > ul' ).hide();
        ...
        window.colorboxinit = function () {
            var yit_lightbox;
            (yit_lightbox = function () {
                jQuery(document).on('hover', 'a.thumb.video, a.thumb.img, img.thumb.img, img.thumb.project, .work-thumbnail a, .three-columns li a, .onlytitle, .overlay_a img, .nozoom img', function () {
...
//            );
                ...
                }, "a.thumb.video, a.thumb.img, a.related_detail, a.related_proj, a.related_video, a.related_title, a.project, a.onlytitle");
...
//                jQuery(document).on('colorbox', 'a.thumb.img, .overlay_img, .section .related_proj', {
//                    transition: 'elastic',
//                    rel: 'lightbox',
//                    fixed: true,
//                    maxWidth: '100%',
...
//                jQuery(document).on('colorbox', '.section .related_lightbox', {
//                    transition: 'elastic',
//                    rel: 'lightbox2',
//                    fixed: true,
//                    maxWidth: '100%',
...
//                jQuery(document).on('colorbox', 'a.thumb.img, .overlay_img, .section.portfolio .related_proj', {
//                    transition: 'elastic',
//                    rel: 'lightbox',
//                    fixed: true,
//                    maxWidth: '80%',
...
//                jQuery(document).on('colorbox', '.section.portfolio .related_lightbox', {
//                    transition: 'elastic',
//                    rel: 'lightbox2',
//                    fixed: true,
//                    maxWidth: '80%',
...
//            jQuery(document).on('colorbox', 'a.thumb.video, .overlay_video, .section.portfolio .related_video',
//                    {
//                        transition: 'elastic',
//                        rel: 'lightbox',
//                        fixed: true,
...
//            jQuery(document).on('colorbox', '.section.portfolio .lightbox_related_video', {
//                transition: 'elastic',
//                rel: 'lightbox2',
//                fixed: true,
//                maxWidth: '60%',
...
//            });
        ...
        $(".gallery-wrap .internal_page_item, .section .related_project > div").live('mouseover mouseout', function (event) {
            if (event.type == 'mouseover')
                $('.overlay', this).show().stop(true, false).animate({opacity: .7}, "fast");
