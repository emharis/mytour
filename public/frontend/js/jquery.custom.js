...
//////// prettyPhoto ////////// 
    ...
    function callprettyPhoto() {
        var len = $('a[data-rel=prettyPhoto]').length;
        if (len > 0) {
            ...
            // Pretty photo custim untuk footer page //
            $('a.photozoom[data-rel]').each(function () {
                $(this).attr('rel', $(this).data('rel'));
            });
            $("a.photozoom[rel^='prettyPhoto']").prettyPhoto({social_tools: false, deeplinking: false});
        }
...
////////// Back to Top //////////
    ...
    /**
     * footer random gallery image 
     */
    $('.with-bg-size').each(function () {
        $(this).css("background-image", 'url(' + $(this).attr('rel') + ')');
    });

    /**
     * Fix Top Logo position
     */
    $('.logo').css('margin-top', (120 - $('.logo').height()) / 2);
