<div class="row header"><!-- Begin Header -->
    ...
    <div class="span5 logo">
        <a href="front/home"><img src="frontend/img/{{$constval['main_logo']}}" alt="" /></a>
        <!--<h5>deep view of indonesia</h5>-->
    </div>
    ...
    <div class="span7 navigation">
        <div class="navbar hidden-phone">
            ...
            <ul class="nav">
                @for($i=0;$i<count($menus);$i++)
                    ...
                    @else
                    <li><a href="{{$menus[$i]['link']}}">{{$menus[$i]['nama']}}</a></li>    
                    @endif
        ...
        <form action="#" id="mobile-nav" class="visible-phone">
            <div class="mobile-nav-select">
                <select style="width:100%;" onchange="window.open(this.options[this.selectedIndex].value, '_top')">
