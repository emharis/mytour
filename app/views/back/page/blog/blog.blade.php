                    ...
                    <table class="table table-bordered datatable" id="table-blog">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-xs btn-primary btn-edit-blog" data-id="{{$dt->id}}" ><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-xs btn-danger btn-del-blog" data-id="{{$dt->id}}" ><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
