...
<div class="content-wrapper" id="page-index">
    ...
    <section class="content-header">
        <h1>Destinasi <i class="fa fa-angle-double-right" ></i> Edit</h1>
    </section>
        ...
        <div class="row" id="row-table">
            <div class="col-md-12" id="box-upload">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form id="form-new-destinasi" action="admin/page/destinasi/edit-kategori" method="POST" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>Nama</td>
                                        <td>
                                            <input value="{{$kategori->nama}}" autocomplete="off" type="text" class="form-control" name="nama" required/>
                                        </td>
                                        <td rowspan="3" class="col-md-4" >
                                            <img src="{{$kategori->img_path . $kategori->filename}}" id="imgPreview" style="width: 270px;height: 220px;" />
                                        </td>
                                    </tr>
                                    <tr>
