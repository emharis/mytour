<div class="modal" id="modalTambahRoom" data-backdrop="static" data-keyboard="false">
...
//                    alert("The image width is " + this.width + " and image height is " + this.height);                    
        ...
        //pilih image
//        $(document).on('click','#btnPilihImage',(function(e) {
//            var getImageUrl = "{{URL::to('admin/paket/hotel/show-modal-pilih-image')}}/" + $('input[name=hotelid]').val();
//            alert(getImageUrl);
////            alert(getImageUrl);
//            $.get(getImageUrl, null, function(ge) {
//                $('#tempModalPilihImage').html(ge);
//            });
//        });
    });
</script>