...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Edit Hotel <i class="fa fa-angle-double-right"></i>  Edit Room
        </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-8" >
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Room "{{$hotel->nama}}"</h3>
                        <div class="pull-right">
                            <a class="btn btn-sm btn-danger" href="{{URL::to('admin/paket/hotel/edit/' . $hotel->id . '#tab_3')}}" >Cancel</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <form name="formModalTambahRoom" id="formModalTambahRoom" action="admin/paket/hotel/editroom" method="POST">
                            <input type="hidden" name="hotelid" value="{{$hotel->id}}"/>
                            <input type="hidden" name="roomId" value="{{$room->id}}"/>
                            <input type="hidden" name="hotel_image_id" value="{{$room->hotel_image_id}}" />
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="nama" class="form-control" value="{{$room->nama}}" required/>
                                        </td>
                                        <td rowspan="4" class="col-md-4">
                                            @if($cover->islocal =='Y')
                                            <img id="imgPrevTambahImageHotel" style="width: 100%;" src="{{$img_path  . $cover->filename}}" />
                                            @else
                                            <img id="imgPrevTambahImageHotel" style="width: 100%;" src="{{$cover->filename}}" />
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" name="harga" class="form-control text-right currency" value="{{number_format($room->harga,2)}}" required/>        
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="publish" class="form-control">
                                                <option value="Y" {{$room->publish == 'Y' ? 'selected':''}} >PUBLISH</option>
                                                <option value="N" {{$room->publish == 'N' ? 'selected':''}} >DRAFT</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" >
                                            <textarea name="desc" class="tinymce-mid" >{{$room->desc}}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
