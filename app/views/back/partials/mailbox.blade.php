...
<html>
  <head>
    ...
    <!-- fullCalendar 2.2.5-->
    <link href="backend/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
    <link href="backend/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet" type="text/css" media='print' />
    <!-- Theme style -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="backend/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
