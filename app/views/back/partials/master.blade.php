...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.2 -->
        <link href="backend/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />
        <!-- Font Awesome Icons -->
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="backend/index2.html" class="logo"><b>Web</b>MANAGER</a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview {{((Request::is('admin/page*') && !Request::is('admin/page/blog*')) ?'active':'')}}" >
                            <a href="#">
                        ...
                        <li class="treeview {{(Request::is('admin/page/blog*')||Request::is('admin/page/comment')?'active':'')}}" >
                            <a href="#">
                                <i class="fa fa-file"></i>
                                <span>Blogs</span><i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="{{(Request::is('admin/page/blog/kategori*')?'active':'')}}"><a href="admin/page/blog/kategori"><i class="fa fa-circle-o"></i> Kategori</a></li>
                                <li class="{{(Request::is('admin/page/blog*')?'active':'')}}"><a href="admin/page/blog"><i class="fa fa-circle-o"></i> Blogs</a></li>
                                <li class="{{(Request::is('admin/page/blog/comment*')?'active':'')}}"><a href="admin/page/blog/comment"><i class="fa fa-circle-o"></i> Comments</a></li>                                
                            </ul>
                        </li>
                        <li class="treeview {{(Request::is('admin/testimoni')?'active':'')}}" >
                        ...
                        <li class="treeview {{(Request::is('admin/message*')?'active':'')}}" >
                            <a href="#">
                                <i class="fa fa-envelope"></i>
                                <span>Message</span><i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="{{(Request::is('admin/message*')?'active':'')}}"><a href="admin/message"><i class="fa fa-circle-o"></i> Inbox</a></li>
                                <li class="{{(Request::is('admin/message/sent*')?'active':'')}}"><a href="admin/message/sent"><i class="fa fa-circle-o"></i> Sent</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
        ...
        <!--Text area autosize-->
        <script src="backend/plugins/autosize/autosize.min.js" type="text/javascript"></script>
        @yield('scripts')
