...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Blog <i class="fa fa-angle-double-right" ></i> Edit</h1>
    </section>
            ...
            <div class="col-md-12" id="box-upload">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h4 id="label-title" >{{$blog->title}}</h4>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form id="form-new-blog" action="admin/page/blog/edit" method="POST" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td >
                                            <div class="row">
                                                <div class="col-md-8">
                                                    {{Form::select('kategori',$selectKategori,$blog->category_id,array('class'=>'form-control','required'))}}
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <td rowspan="5" class="col-md-4">
                                            @if($blog->islocal == 'Y')
                                            <img id="imagePreview" style="width: 100%;"  src="{{$imgpath . $blog->img_cover}}" />
                                            @else
                                            <img id="imagePreview" style="width: 100%;" src="{{$blog->img_cover}}"/>
                                            @endif
                                    ...
                                    <tr>
                                        <td>Judul</td>
                                        <td >
                                            <input value="{{$blog->title}}" type="text" class="form-control" name="title" required/>
                                        </td>
                                    </tr>                                
                                    <tr>
                                        <td rowspan="2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <select class="form-control" name="publish">
                                                        <option value="Y" {{$blog->publish == 'Y' ? 'selected':''}} >Publish</option>
                                                        <option value="N" {{$blog->publish == 'N' ? 'selected':''}} >Draft</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        <td colspan="3" >
                                            <textarea id="textarea-new" maxlength="500" class="form-control" name="min_content" >{{$blog->min_content}}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Content</td>
                                    ...
                                    <tr>
                                        <td colspan="3" >
                                            <textarea id="textarea-new" class="tinymce-full" name="content" >{{$blog->content}}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
<script>
    $(document).ready(function() {
        //keypress binding untuk title
        $('input[name=title]').keyup(function(){
            $('#label-title').text($(this).val());
        });
