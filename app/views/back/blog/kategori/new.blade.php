...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Kategori <i class="fa fa-angle-double-right" ></i> Tambah</h1>
    </section>
        ...
        <div class="row" id="row-table">
            <div class="col-md-12" id="box-upload">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form id="form-new-kategori" action="admin/page/blog/new-kategori" method="POST" enctype="multipart/form-data" onsubmit="btnSubmit.disabled=true;return true;"  >
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>Nama</td>
                                        <td><input required type="type" name="name" class="form-control" /></td>
                                    </tr>
                                    <tr>
                                        <td>
