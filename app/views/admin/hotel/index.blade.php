...
<div class="page-header">
    <a href="admin/paket/hotel/new" class="btn btn-sm btn-primary pull-right">New</a>
    <h1>
        Hotel
    </h1>
</div><!-- /.page-header -->
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="admin/paket/hotel/edit/{{$tst->id}}">
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>

                                <a class="red btn-delete" href="admin/paket/hotel/delete/{{$tst->id}}" >
