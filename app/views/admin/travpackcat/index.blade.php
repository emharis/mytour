...
<div class="page-header">
    <a href="admin/paket/travpackcat/new" class="btn btn-sm btn-primary pull-right">New</a>
    <h1>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="admin/paket/travpackcat/edit/{{$tst->id}}">
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>

                                <a class="red btn-delete" href="admin/paket/travpackcat/delete/{{$tst->id}}" >
