...
<html lang="en">
    <head>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="adm/css/ace.min.css" />
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                ...
                                <h4 class="light-blue" id="id-company-text">Login</h4>
                            </div>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            @if($error != null)
                                            <h4 class="center">
                                                <span class="label label-danger arrowed-in arrowed-in-right ">Username/password not valid</span>
                                            </h4>
                                            @endif
...
<!--                                            <div class="social-or-login center">
                                        ...
                                        <div class="toolbar clearfix">
                                            ...
                                            <div>
                                                <a href="#" data-target="#signup-box" class="user-signup-link" style="visibility: hidden;">
                                                    I want to register
