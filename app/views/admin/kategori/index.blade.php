...
<div class="page-header">
    <a href="admin/blogs/kategori/new" class="btn btn-sm btn-primary pull-right">New</a>
    <h1>
        Kategori
    </h1>
</div><!-- /.page-header -->
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="admin/blogs/kategori/edit/{{$kat->id}}">
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>

                                <a class="red btn-delete" href="admin/blogs/kategori/delete/{{$kat->id}}" >
