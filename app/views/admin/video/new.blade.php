...
<div class="row">
    <div class="col-xs-12">
        ...
        <div>
            ...
            <form class="form-horizontal" method="POST" action="{{URL::to('admin/gallery/video/new')}}" enctype="multipart/form-data">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-sm-6">
                                ...
                                {{Form::text('videourl',null,array('class'=>'col-sm-12','placeholder'=>'Youtube Video ID'))}}
                            </td>
